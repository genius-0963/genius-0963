...
<div align="center">👋 Hi, I’m Saurabh Kumar

A Motivated  student for Software Engineer and Machine Learning Engineer, currently pursuing Electronics and Communication Engineering at IIIT Allahabad. I enjoy building practical, scalable software systems and integrating intelligent models into real-world applications.

Alongside software development, I actively work in machine learning, focusing on end-to-end pipelines—from data preprocessing and model training to evaluation and deployment. My ML projects include a student rank prediction model, a gesture-controlled YouTube system, and applied ML solutions built using Python, Pandas, NumPy, Scikit-learn, and LightGBM.

🚀 Projects:

Learning Management System (LMS) – scalable MERN-based platform
Student Job Tracker – full-stack application for tracking placements
Retail Daddy – offline-first retail management system
Student Rank Predictor – ML model integrated into a production app
Real-Time Object Detection – Computer vision system using live camera feeds
Real-Time Speech Separation Toolkit – AI toolkit for isolating voices from audio streams
Gesture-Controlled YouTube System – CV + ML-based automation tool

📌 I’m passionate about system design, real-time ML applications, and building impactful software at the intersection of software engineering and machine learning.
</div>
